<template>
  <section class="sprint-recodesection">
...
.sprint-recodesection[view] .slash {
...
.sprint-recodesection[view] .inner-slash {
  animation-name: SpreadHeightSlash,  SpreadWidthSlash;
...
.sprint-recodesection[view] .content h1 {
